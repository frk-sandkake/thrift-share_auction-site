              ...
              <div role="none" aria-label="Info about thrift and auction" class="w-12/12 px-2 py-2">
                ...
                <div role="group" aria-label="Buttons View and/or Add bid" class="flex flex-row justify-around items-start">
                  ...
                  <button id="addBid" type="button"
                          class="inline-block rounded-full p-0.5 text-pink-400 drop-shadow-sm group bg-gradient-to-b from-pink-400 via-pink-600 to-pink-800 group-hover:bg-gradient-to-br hover:text-pink-50 focus:ring-2 focus:outline-none focus:ring-pink-300"
                  >
